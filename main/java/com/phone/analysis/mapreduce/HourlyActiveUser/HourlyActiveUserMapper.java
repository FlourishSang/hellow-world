...
public class HourlyActiveUserMapper extends Mapper<LongWritable, Text,StatsUserDimension, TimeOutputValue> {
    ...
    private KpiDimension hourActiveUser = new KpiDimension(KpiType.HOUR_ACTIVE_USER.kpiName);
    //获取浏览器模块下的的活动用户的KPI
//    private KpiDimension browserHourActiveUser = new KpiDimension(KpiType.BROWSER_HOUR_ACTIVE_USER.kpiName);
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if (StringUtils.isNotEmpty(en) && en.equals(Constants.EventEnum.LAUNCH.alias)) {
           ...
           String  platform = fields[13];
            ...
            this.outputValue.setTime(stime);
            ...
            statsCommonDimension.setKpi(hourActiveUser);
            ...
            //浏览器模块下的赋值
//            statsCommonDimension.setKpi(browserHourActiveUser);
