...
/**
 * @description 解析ip的工具类
 * @author: 赵燕钦
 * @create: 2018-11-28 17:58:52
 **/
public class IpParsingUtil  extends IPSeeker{
    //设置全局的Logger对象
    private static Logger logger = Logger.getLogger(IpParsingUtil.class);
   ...
   /*
   * 类RegionInfo用于封装解析出来的地域信息
   * */
   public static class RegionInfo{
        //定义一个全局的常量通过类名获取数据到然后赋值给default_value属性
       private String default_value = GlobleConstants.DEFAULT_VALUE;
